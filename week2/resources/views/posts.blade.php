<x-layout>
            ...
            <form>
                ...
                <div class="items-center mx-auto mb-3 space-y-4 max-w-screen-sm sm:flex sm:space-y-0">
                    <div class="relative w-full">
                        <label for="email" class="hidden mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Serach for article</label>
    ...
    <div class=" my-4 py-4 mx-auto max-w-screen-xl lg:py-8  lg:px-0">
